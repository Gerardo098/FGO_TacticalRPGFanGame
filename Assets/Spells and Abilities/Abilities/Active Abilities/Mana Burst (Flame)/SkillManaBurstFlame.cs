...
/// <summary>
/// SkillManaBurstFlame is a subclass of the ActiveAbility script 
...
/// </summary>
[CreateAssetMenu(menuName = "Ability/Active Ability/Mana Burst (Flame)")]
public class SkillManaBurstFlame : Ability
{
    [SerializeField]
    private Status_ManaBurstFlame mbFlame; // Status effect reference
    public override void Activate(CharacterManager charMan, GameObject target = null)
    {
        ...
        mbFlame.SetOgRank(GetCurrentRank()); // Set the ability's original rank = our skill's current rank
        // Create the effect instance
        EffectInstance instance = new EffectInstance(mbFlame, charMan, charMan);
